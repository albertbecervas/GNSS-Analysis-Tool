...
package com.abecerra.pvt_ephemeris_client.suplclient.ephemeris;


import com.abecerra.pvt_ephemeris_client.suplclient.supl.Ephemeris;
...
public class EphemerisResponse {
    ...
    /* Constructor */
    public EphemerisResponse(List<GnssEphemeris> ephList, Ephemeris.IonosphericModelProto ionoProto) {
