...
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.supl_pos_init.NavigationModel;
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.supl_pos_init.RequestedAssistData;
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.supl_pos_init.SUPLPOSINIT;
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.supl_start.*;
...
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.ulp_components.*;
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.ulp_components.PositionEstimate.latitudeSignType;
import com.abecerra.pvt_ephemeris_client.suplclient.asn1.supl2.ulp_version_2_parameter_extensions.*;
 ...
 * GPS socket.
 *
 * <p>Two types of SUPL payloads are supported in this version: Local EphLocation and WCDMA versions.
...
abstract class SuplMessagesGenerator {
    ...
    public ULP_PDU newSuplPosInitMessage(SessionID sessionId, long latE7, long lngE7) {
        ...
        long latSuplFormat =
                (long) (Math.abs(latE7) / (SuplConstants.UlpConstants.POSITION_ESTIMATE_LAT_SCALE_FACTOR * 1E7));
        long lngSuplFormat = (long) (lngE7 / (SuplConstants.UlpConstants.POSITION_ESTIMATE_LNG_SCALE_FACTOR * 1E7));
    ...
    private UlpMessage newSuplPosInitMessage() {
        UlpMessage message = new UlpMessage();
        SUPLPOSINIT suplPosInit;
        suplPosInit = message.setMsSUPLPOSINITToNewInstance();
        ...
        glonassRequest.setGanssIdToNewInstance().setLong(SuplConstants.UlpConstants.ULP_GANSS_ID_GLO);
        ...
        galileoRequest.setGanssIdToNewInstance().setLong(SuplConstants.UlpConstants.ULP_GANSS_ID_GAL);
