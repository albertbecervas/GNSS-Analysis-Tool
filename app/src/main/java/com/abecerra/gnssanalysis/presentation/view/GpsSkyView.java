...
import com.abecerra.gnssanalysis.app.utils.skyplot.GnssType;
import com.abecerra.gnssanalysis.app.utils.skyplot.GpsTestUtil;
import com.abecerra.gnssanalysis.app.utils.skyplot.MathUtils;
import com.abecerra.gnssanalysis.app.utils.skyplot.UIUtils;
...
//                break;
    ...
    /**
     * Returns true if the pvtApp is monitoring the legacy GpsStatus.Listener, or false if the pvtApp is monitoring the GnssStatus.Callback
     *
     * @return true if the pvtApp is monitoring the legacy GpsStatus.Listener, or false if the pvtApp is monitoring the GnssStatus.Callback
     */
