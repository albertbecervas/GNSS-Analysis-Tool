package com.abecerra.gnssanalysis.app.utils.skyplot;
...
import static com.abecerra.gnssanalysis.app.utils.skyplot.GnssType.*;
...
public class GpsTestUtil {
    ...
    /**
     * Returns true if the pvtApp is running on a large screen device, false if it is not
     *
     * @return true if the pvtApp is running on a large screen device, false if it is not
     */
